///
/// Variant_NullType_MpvNowPlayingInfo.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_MpvNowPlayingInfo {
  case first(NullType)
  case second(MpvNowPlayingInfo)
}

public extension Variant_NullType_MpvNowPlayingInfo {
