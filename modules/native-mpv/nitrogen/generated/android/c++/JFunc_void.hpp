...
namespace margelo::nitro::nativempv {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nativempv/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nativempv/Func_void_cxx;";
