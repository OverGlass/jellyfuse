...
namespace margelo::nitro::nativempv {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nativempv/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nativempv/Func_void_std__string_cxx;";
