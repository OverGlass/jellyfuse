...
/**
 * Represents the JavaScript callback `(positionSeconds: number, durationSeconds: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(positionSeconds: Double, durationSeconds: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(positionSeconds: Double, durationSeconds: Double): Unit
    = invoke_cxx(positionSeconds,durationSeconds)

  @FastNative
  private external fun invoke_cxx(positionSeconds: Double, durationSeconds: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(positionSeconds: Double, durationSeconds: Double): Unit {
    return this.function(positionSeconds, durationSeconds)
  }
}
