...
namespace margelo::nitro::nativempv {
  ...
  /**
   * A struct which can be represented as a JavaScript object (MpvNowPlayingInfo).
   */
  struct MpvNowPlayingInfo final {
  public:
  ...
  public:
    MpvNowPlayingInfo() = default;
    explicit MpvNowPlayingInfo(std::string title, std::optional<std::string> subtitle, std::optional<std::string> artworkUri, std::optional<double> durationSeconds, std::optional<bool> isLiveStream): title(title), subtitle(subtitle), artworkUri(artworkUri), durationSeconds(durationSeconds), isLiveStream(isLiveStream) {}

  public:
    friend bool operator==(const MpvNowPlayingInfo& lhs, const MpvNowPlayingInfo& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ MpvNowPlayingInfo <> JS MpvNowPlayingInfo (object)
  template <>
  struct JSIConverter<margelo::nitro::nativempv::MpvNowPlayingInfo> final {
    static inline margelo::nitro::nativempv::MpvNowPlayingInfo fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nativempv::MpvNowPlayingInfo(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nativempv::MpvNowPlayingInfo& arg) {
